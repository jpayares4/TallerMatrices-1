    ...
    public static void letraB(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (j == 0 || i == 0 && j<nc-1 ||i==nf/2 && j<nc-1 || i==nf-1 && j<nc-1 ||i==nf/2-1 && j==nc-1 || i==nf/2+1 && j==nc-1 ) {
  ...
  public static void letraK(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (j == 0 || i == 0 && j == nc-1 ||i==nf/2-1 && j == nc-2 || i==nf/2 && j == nc/2-1 ||i==nf/2+1 && j== nc-2 || i==nf-1 && j== nc-1 ) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
      ...
      public static void letraM(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (j == 0 || j == nc-1 || i == nf/2 && j==nf/2 || i == nf/2-1 &&  j != nc/2  ) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
      ...
      public static void FiguraI(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (i == 0 || i == nf-1 || i == nf/2-2 && j>0 && j< nc-1 || i== nf/2+1 && j>0 && j< nc-1 || j== nc/2  ) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
  ...
  public static void FiguraII(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (j == 0 || j == nf || i==nc/2-1 ||  i==nf/2-1 && j!=(nc-1)/2 && j!=(nc-1)/2+1 || i==nf/2+1 && j!=(nc-1)/2 && j!=(nc-1)/2+1 ) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
   ...
   public static void FiguraIII(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (j==nf/2 || j==nf/2-1 || i==nf/2 || i==nf/2-1) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
    ...
    public static void FiguraIV(JTable tabla1, JTable tabla2) {
         int nf, nc, aux;
        nc = tabla1.getColumnCount();
        nf = tabla1.getRowCount();
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (i==j -nf/2 || i==j +nf/2  ||nf+nf/2-1-i==j ||nf-nf/2-1-i==j  ) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
    ...
    public static void letraW(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (j==0 || j==nc-1 || i==nc-1 && j!=(nc-1)/2 || j == nc/2 && i>=(nf-1)/2 && i!=(nf-1) ) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
        }
    ...
    public static void letraQ(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (i==0 && j!=0 && j!=nf-1 || i==j && i>nf/2 || j==0 && i<=nf/2 && i!=0 || j==nc-1 && i<=nf/2 && i!=0 || nf/2+1==i && j!=0 && j!=nf-1) {
                    tabla2.setValueAt(aux, i, j);
                }
    ...
    public static void letraJ(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (i==0 || j==nc/2 || j==0 && i>nf/3 || i==nf-1 && j<nc/2 ) {
                    tabla2.setValueAt(aux, i, j);
                }
    ...
    public static void letraG(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                ...
                if (j==0 || i==0 || i==nf-1 || j==nc-1 && i>=nc-1 || j==nc-1 && i<=1 || i==nf/2) {
                    tabla2.setValueAt(aux, i, j);
                }
